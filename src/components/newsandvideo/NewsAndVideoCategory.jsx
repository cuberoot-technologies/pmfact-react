    ...
    return (
        <>
            ...
            <div className="container" id="categorypage">
                    ...
                    <div className="categorynewssection">
                        <div className="parliament-news-video-mp-news">
                            <div className="news-pu" id="category-page-news-pu">
                                <Link to="/news-and-videos-page" className="singlepagelink">
                                    <div className="parliament-news-video-mp-news-list" id="category-page-box-news">
                ...
                <div className="category-page-trending">
                    <MpNewsPage />
                    <TrendingNews />
                    <TrendingNews />
                </div>
